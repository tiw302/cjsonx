...
int main() {
    ...
    // cjsonx parses and validates these numbers using clinger's fast path and eisel-lemire internally
    // ensuring they conform strictly to rfc 8259 without crashing or throwing
