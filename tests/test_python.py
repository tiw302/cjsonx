"""
file: test_python.py
description: unit testing suite for the python bindings. uses python's
unittest framework to verify that the c-extension parses json correctly,
that the document/node classes expose data accurately, and that memory
is safely managed between c and python.
"""
import unittest
import cjsonx
